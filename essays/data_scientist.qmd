...
The last way I've grown as a data scientist this quarter has been through learning to make my output more professional. Earlier in the class, I would often forget to remove error messages, and I didn't understand that I needed to clearly output what each question was asking, and find the best R tool to give me that output. Throughout the course, I learned how to use different functions such as slice_max() to get single rows of a dataframe to ensure that there was no unnecessary output. This can be seen in Lab 4, Question 4.

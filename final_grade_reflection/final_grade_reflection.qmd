...
One example where I extended my thinking is when I used lubridate functions in Challenge 4, Part 1 to complete the problem, when we had not learned lubridate tools in class yet.
